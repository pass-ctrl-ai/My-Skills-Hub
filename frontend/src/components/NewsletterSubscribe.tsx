        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-3">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-[var(--ps-radius-card)] bg-white/20 flex items-center justify-center shrink-0">
              ...
              <div>
                <form onSubmit={handleSubmit} className="space-y-3">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-white/20 rounded-[var(--ps-radius-card)] bg-white/10 text-white text-sm placeholder-indigo-200 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent"
                    aria-label="Email address"
                  />
                  <button
                    type="submit"
                    disabled={!email.trim() || status === "loading"}
                    className="w-full px-5 py-3 bg-white text-indigo-600 rounded-[var(--ps-radius-card)] text-sm font-semibold hover:bg-indigo-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer flex items-center justify-center gap-2"
                  >
                    {status === "loading" && (
