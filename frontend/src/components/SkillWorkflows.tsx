    ...
    <section className="mb-10">
      <div className="mb-5">
        <div className="flex items-center gap-2">
          <svg className="w-5 h-5 text-[var(--ps-neon-cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z"/></svg>
          <h2 className="text-lg font-bold text-[var(--ps-text-primary)]">{t("workflows.title")}</h2>
          <span className="text-sm text-[var(--ps-text-muted)]">{t("workflows.subtitle")}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {workflows.map((wf) => (
          <div
            key={wf.id}
            className="ps-card rounded-[var(--ps-radius-card)] border border-[var(--ps-border)] p-5 hover:shadow-md hover:-translate-y-0.5 transition-all"
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 rounded-lg bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center shrink-0">
                <svg className="w-5 h-5 text-[var(--ps-neon-cyan)] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[var(--ps-text-muted)]">
              ...
              {wf.skills.map((skill, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {skill.stars > 0 && (
                      <span className="text-xs text-[var(--ps-text-muted)] flex items-center gap-0.5">
                    ...
                    <svg className="w-3.5 h-3.5 text-[var(--ps-text-muted)] group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* View All link */}
            <div className="border-t border-[var(--ps-border)] pt-3 mt-3">
              <button
                onClick={() => navigate(`/?tab=explore&category=${wf.id}`)}
                className="w-full flex items-center justify-center gap-1.5 text-sm text-[var(--ps-neon-cyan)] hover:text-blue-700 font-medium transition-colors cursor-pointer group"
              >
